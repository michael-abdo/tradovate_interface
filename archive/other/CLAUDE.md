...
### **APPLICATION STARTUP**
- **Primary Command**: `python3 start_all.py` - Starts the complete trading system
- **Components Started**: Dashboard, Chrome management, account monitoring
- **Run From**: `/Users/Mike/trading/tradovate_interface/` directory
- **Monitoring**: Use tmux session `stocks` with window `start_all` to view logs
