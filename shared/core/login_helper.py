...
try:
    ...
    try:
        ...
        # Define dummy functions to continue
        def inject_login_script(tab, username, password):
            # This function should inject login script but we'll handle it differently
            return True
        def disable_alerts(tab):
            # This function should disable alerts
            return True
...
def login_to_existing_chrome(port=None, username=None, password=None, tradovate_url="https://trader.tradovate.com"):
    ...
    if not (username and password):
        try:
            from utils.chrome_communication import get_unified_single_credential
