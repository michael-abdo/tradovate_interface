...
class TradovateConnection:
        ...
        for tab in self.browser.list_tab():
            try:
                ...
                if "tradovate" in url:
                    ...
                    # Don't stop non-Tradovate tabs - let Chrome manage tab lifecycle
                    print(f"Ignoring non-Tradovate tab for system stability")
            except Exception as e:
                print(f"Error processing tab: {e}")
                # Don't stop tabs on error - they might be recoverable or needed by other parts
                print(f"Leaving tab alone due to processing error")
    ...
    def auto_trade(self, symbol, quantity=1, action='Buy', tp_ticks=100, sl_ticks=40, tick_size=0.25):
        ...
        try:
            ...
            from utils.chrome_communication import execute_auto_trade_with_validation
    ...
    def exit_positions(self, symbol, option='cancel-option-Exit-at-Mkt-Cxl'):
        ...
        try:
            ...
            from utils.chrome_communication import execute_exit_positions_with_validation
    ...
    def update_symbol(self, symbol):
        ...
        try:
            ...
            from utils.chrome_communication import execute_symbol_update_with_validation, sync_symbol_across_tabs
    ...
    def test_order_validation(self):
        ...
        try:
            ...
            from utils.test_order_validation_live import OrderValidationLiveTester
