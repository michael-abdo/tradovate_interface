...
# ============================================================================
# PYCHROME ERROR SUPPRESSION - Apply globally at startup
# ============================================================================
...
# Apply PyChrome error suppression globally
sys.stderr = PyChromeStderrFilter(sys.stderr)
print("✅ PyChrome error suppression enabled")
...
def run_auto_login():
    ...
    try:
        ...
        auto_login_path = os.path.join(project_root, "auto_login.py")
